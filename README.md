...
![Accuracy Plot](images/accuracy_plot.png) <!-- Вам нужно добавить эту картинку вручную -->

## 🛠️ Установка и Использование

1.  **Клонируйте репозиторий:**
    ```bash
    git clone https://github.com/your_username/FaceRecognitionStarter.git
    cd FaceRecognitionStarter
    ```
